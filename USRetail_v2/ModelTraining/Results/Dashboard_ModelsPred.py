...
# Read files
df_lr = pd.read_csv('lr_prediction.csv')
df_dt = pd.read_csv('dt_prediction.csv')
df_rf = pd.read_csv('rf_prediction.csv')
df_adaboost = pd.read_csv('adaboost_prediction.csv')
df_xgboost = pd.read_csv('xgboost_prediction.csv')
