...
df_hb = supermarket[supermarket['ProductLine']=='Health and beauty']
abtest_result = abtesting(df_hb,'Gender','Cogs',0,'greater than')

f = open('Results/Burmasupermarket_abtesting_hbmale.txt','w')
f.write('-----Result-----\n')
f.write('P-value: ')
